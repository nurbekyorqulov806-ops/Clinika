"""
Klinika boshqaruv tizimi - Django sozlamalari
"""
import os
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-o-zgartiring-buni')
DEBUG = config('DEBUG', default=True, cast=bool)
ALLOWED_HOSTS = [
    'clinika-n7a9.onrender.com',
    'localhost',
    '127.0.0.1',
]
...
# ----------------------------------------------------------------------
# DATABASE - MySQL
# PyMySQL kutubxonasi MySQLdb o'rnini bosadi (mysqlclient talab qilinmaydi)
# ----------------------------------------------------------------------
import pymysql
